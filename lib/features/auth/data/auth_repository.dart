...
String arabicAuthError(Object e) {
  ...
  if (e is FirebaseException) {
    if (e.code == 'permission-denied') {
      // ⚠️ لا تُوجّه المستخدم إلى «انشر القواعد» وحدها.
      //
      // حدث فعلاً أن ظهرت هذه الرسالة والقواعد منشورة، لأن العملية نفسها
      // لم تكن مسموحة في القواعد أصلاً (حذف خريطة عامل). الرسالة القديمة
      // أرسلت صاحب المحل يبحث في الفهارس والنشر بلا طائل.
      return 'القواعد لا تسمح بهذه العملية لهذا الحساب. تأكّد أنك داخل '
          'بحساب صاحب المحل، وأن آخر نسخة من firestore.rules منشورة.';
    }
