...
void main() {
  ...
  //   (سعر بيع كل منتج × كميته) + نقد الصندوق + كريديات الزبائن
  //   − دَين الموردين، ثم × 2.5٪

  group('وعاء الزكاة', () {
    test('المخزون بسعر البيع + النقد + الكريديات − دَين الموردين', () {
      final summary = computeCapital(
      ...
      // 120000 + 30000 + 50000 − 20000 = 180000
      expect(summary.zakatBase, 180000);
      expect(summary.zakat, 4500); // ٢٫٥٪
    });
